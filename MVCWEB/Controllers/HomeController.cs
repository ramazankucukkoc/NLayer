...
namespace IdentityMVCWEB.Controllers
{
    public class HomeController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SignUp(UserDto userViewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public IActionResult ResetPassword(PasswordResetDto passwordResetViewModel)
        {
            ...
            if (user != null)
            {
                ...
                PasswordReset.PasswordResetSendEmail(passwrodResetLink);
        ...
        public async Task<IActionResult> ResetPasswordConfirm([Bind("PasswordNew")] PasswordResetDto passwordResetViewModel)
        {
